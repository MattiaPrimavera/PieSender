...
public class UploadArrayAdapter extends ArrayAdapter<Upload> {
    ...
    public UploadArrayAdapter(Context c, int res, List<Upload> o) {
        super(c, res, o);
        mContext = c;
        mResource = res;
        mObjects = o;
    ...
    public UploadArrayAdapter(Context c, int res) {
        super(c, res);
        mContext = c;
        mResource = res;
        mObjects = new ArrayList<Upload>();
    }
    ...
    /*
        ...
        UploadArrayAdapter contains a list of Files it gets from our model's getAllFiles()
    */
    @Override
